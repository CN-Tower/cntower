...
/*=======================================================
 ...
 ========================================================*/
    ...
    $navBar.css({transition:"margin 0.5s ease-in",backgroundColor:"transparent",marginTop:"20px"})
        .find("a").css({color:"#fff"}).end().find("img").attr("src","img/about/white-62f6f270bcc5.png");
    //鼠标滑动导航条效果
    $document.scroll(function(){
        ...
        if(sTop>0){
            $navBar.css({backgroundColor:"#fff",marginTop:"0"})
                .find("a").css({color:"#000"}).end().find("img").attr("src","img/about/colour-7bad394008cf.png");
        }else{
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if(data.success){
                    ...
                    $("#registerText").val("");
                    getSession();
                    //window.location.href = "home-15ca53e21271.html";
                }else{
                    alert(data.message);
                    $("#username1").val("");
                }
...
//打开页面监听资源加载
var imgUrl = [
    "./img/about/yuan-17942ef4e093.png",
    "./img/home/banners1-d5572878a3e9.jpg",
    "./img/home/banners2-a19c382dfc43.jpg",
    "./img/home/banners3-d79730522ca6.jpg",
    "./img/home/banners4-c5b8d75439ec.jpg",
    "./img/home/banners5-1d550b963877.jpg",
    "./img/home/aboutleft-1a5a31fa90ac.jpg",
    "./img/home/bg_more-44942da25484.png",
    "./img/home/aboutrighttop-a91ab943ad5c.jpg",
    "./img/home/leftbox-54248ebefc82.jpg",
    "./img/home/lefttopbox-9d557fa791f6.jpg",
    "./img/home/leftbottombox-ee5011b5b3b7.jpg"
];
loadWatcher(imgUrl);
