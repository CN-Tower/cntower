...
function startGame(){
    if(isStart==0){
        ...
        main.style.background="url('images/bg-a471dbfd8078.jpg') center center";
        readyMain.style.display="none";
        bgm.src="music/fight-4fde6de9e566.mp3";
        ...
        function setTime() {
            if (countdown == 0) {
                ...
                /*显示时间*/
                if(countdown>=60) {
                    timeImg[1].src="images/num/1-be1e868b3197.gif";
                    var n = countdown-60;
                    timeImg[3].src="images/num/"+parseInt(n/10)+".gif";
                    timeImg[4].src="images/num/"+parseInt(n%10)+".gif";
                }
                else {
                    timeImg[1].src="images/num/0-58f663e057c7.gif";
                    var n = countdown;
                    timeImg[3].src="images/num/"+parseInt(n/10)+".gif";
                    timeImg[4].src="images/num/"+parseInt(n%10)+".gif";
                }
...
startGameBtn.onmouseover=function(){
    startGameBtn.src="images/startOver-30ee754a6b6d.gif";
    BtMouseOver.play();
};
startGameBtn.onmouseout=function(){
    startGameBtn.src="images/start-38cc69e9cca9.gif";
};
startGameBtn.onmousedown=function(){
    startGameBtn.src="images/startClick-860b16be4b73.gif";
    btMouseClick.play();
};
...
overY.onmouseover=function(){
    BtMouseOver.play();
    overY.src="images/ui/tipYO-74555d3a575d.gif";
};
overY.onmouseout=function(){
    overY.src="images/ui/tipY-217e9e424a27.gif";
};
overY.onmousedown=function(){
    btMouseClick.play();
    overY.src="images/ui/tipYC-e627144e2eff.gif";
};
...
tipY.onmouseover=function(){
    BtMouseOver.play();
    tipY.src="images/ui/tipYO-74555d3a575d.gif";
};
tipY.onmouseout=function(){
    tipY.src="images/ui/tipY-217e9e424a27.gif";
};
tipY.onmousedown=function(){
    btMouseClick.play();
    tipY.src="images/ui/tipYC-e627144e2eff.gif";
};
...
tipN.onmouseover=function(){
    BtMouseOver.play();
    tipN.src="images/ui/tipNO-d4e87b59edbe.gif";
};
tipN.onmouseout=function(){
    tipN.src="images/ui/tipN-471d56caf37d.gif";
};
tipN.onmousedown=function(){
    btMouseClick.play();
    tipN.src="images/ui/tipNC-e71b55d238d8.gif";
};
...
backBtn.onmouseover=function(){
    BtMouseOver.play();
    backBtn.src="images/ui/backover-5d062efba998.gif";
};
backBtn.onmouseout=function(){
    backBtn.src="images/ui/back-b4cf05ff472a.gif";
};
backBtn.onmousedown=function(){
    btMouseClick.play();
    backBtn.src="images/ui/backClick-2be35df17dce.gif";
};
...
function skill(){/*一次25滴血*/
    ...
    this.skillNode.src="images/skill-c8b1eac2fd42.gif";
...
function attBallBoss(imgSrc,x,y,speed,power){/*魔法弹对象*/
    ...
    this.power=power;
    this.status = 0;
    this.hitSrc = "images/enemy/boss/attackHit-ffb58da14972.gif";
    this.isDead = false;/*是否消失*/
...
function enemyBird(imgSrc,x,y,speedX,speedY,hp,exp){
    ...
    function attackEnd(){/*攻击结束，变回移动状态*/
        if(issetBOSS){
            var bossAttackBall = new attBallBoss("images/enemy/boss/attackBall-b27a734e7a1a.gif",parseInt(bossEnemy.style.right)+250,parseInt(bossEnemy.style.top)+50,10,7);
...
function dragonDie(){/*死亡后什么都不能干*/
    dragonSmall.enemyNode.src = "images/dragon/dead/die-efdaa5453083.gif";
        ...
        if(!enemyList[i].isDead){
            if(enemyList[i].status==0){
                ...
                if(dragonSmall.exp>=expList[dragonSmall.who]&&changing==0){
                    howExp.style.backgroundImage ="url('images/ui/expFull-fc09ae444f13.gif')";
                    changing=1;/*表示正在进化*/
                    dragonSmall.who++;/*升级*/
...
function fl(){/*闪烁*/
   ...
   if(ii>=10) {
        LevelUp.play();
        howExp.style.backgroundImage ="url('images/ui/expMax-9ed42b1a7766.gif')";
...
function things(x,y){
    ...
    this.thingNode.src = "images/enemy/thing-bf30fe899df1.gif";
